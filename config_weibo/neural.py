_hidden_size = 200
_code_len = 800
_save_path = 'save_weibo/neural/model_1'
_neural_save_path = 'save_weibo/neural/keyword_1'
_conversation_save_path = 'save_weibo/neural/logs/conversation_logs.txt'
_simulation_save_path = 'save_weibo/neural/logs/simulation_logs.txt'
_max_epoch = 10
