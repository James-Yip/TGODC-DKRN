...
_save_suffix = '1'
_kp_save_path = 'save_weibo/%s/keyword_predictor_%s' % (_save_dir_name, _save_suffix)
_retrieval_save_path = 'save_weibo/%s/response_retrieval_%s' % (_save_dir_name, _save_suffix)
_log_save_path = 'save_weibo/%s/logs/training_logs.txt' % _save_dir_name
_conversation_save_path = 'save_weibo/%s/logs/conversation_logs.txt' % _save_dir_name
_simulation_save_path = 'save_weibo/%s/logs/simulation_logs.txt' % _save_dir_name
_max_epoch = 20
_dropout_rate = 0.5
