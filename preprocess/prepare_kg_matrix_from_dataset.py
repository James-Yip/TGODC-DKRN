...
for stage in ['train', 'valid', 'test']:
    ...
    context_file = open("../tx_data/{}/context.txt".format(stage), "r")
    context_list = [x.strip() for x in context_file.readlines()]

    keywords_file = open("../tx_data/{}/keywords.txt".format(stage), "r")
    ...
    candicate_mask = open("../tx_data/{}/candicate_mask.txt".format(stage), "w+")
    ...
    save_matrix("../tx_data/{}/kg_adjacent_matrix.txt".format(stage), kg_adjacent_matrix)
    with open("../tx_data/{}/kg_adjacent_matrix.json".format(stage), "w+") as kg_adjacent_dict_file:
